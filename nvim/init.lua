...
require('lazy').setup({
  ...
  -- See the custom plugins gitsigns.lua for the extra configuration
          ...
          live_grep_args = {
            ...
            mappings = {
              i = {
                ...
                ['<C-space>'] = lga_actions.to_fuzzy_refine, -- freeze and start fuzzy search on current list and start fuzzy search
              },
            },
          },
        },
